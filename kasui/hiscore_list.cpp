...
void
hiscore_list_impl::redraw() const
{
#if 1
...
void
hiscore_list_impl::update(uint32_t dt)
{
	extern int total_tics;
	total_tics += dt;
...
void
hiscore_list_impl::on_touch_down(float x, float y)
{
...
void
hiscore_list_impl::on_touch_move(float x, float y)
{
	if (pause_button_.on_touch_down(x, y))
		return;
...
void
hiscore_list_state::reset()
{
	impl_->reset();
}

void
hiscore_list_state::redraw() const
{
	impl_->redraw();
}

void
hiscore_list_state::update(uint32_t dt)
{
	impl_->update(dt);
}

void
hiscore_list_state::on_touch_down(float x, float y)
{
	impl_->on_touch_down(x, y);
}

void
hiscore_list_state::on_touch_up()
{
	impl_->on_touch_up();
}

void
hiscore_list_state::on_touch_move(float x, float y)
{
	impl_->on_touch_move(x, y);
}

void
hiscore_list_state::on_back_key()
{
	impl_->on_back_key();
}

void
hiscore_list_state::on_menu_key()
{
	impl_->on_menu_key();
}
