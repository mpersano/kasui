...
void
program_wrapper::load_and_compile()
{
	program_->initialize();
...
void
program_wrapper::set_proj_modelview_matrix(const g2d::mat4& projection) const
{
	g2d::program::set_uniform(proj_modelview_matrix_location_, projection);
}

void
program_wrapper::set_proj_modelview_matrix(const GLfloat *projection) const
{
...
void
program_flat::bind_attribute_locations()
{
	program_->bind_attrib_location(0, "position");
}

void
program_flat::initialize_uniform_locations()
{
	color_location_ = program_->get_uniform_location("color");
}

void
program_flat::set_color(const g2d::rgba& color) const
{
...
void
program_color::bind_attribute_locations()
{
	program_->bind_attrib_location(0, "position");
...
void
program_color::initialize_uniform_locations()
{ }
...
void
program_texture_base::set_texture(int texunit) const
{
...
void
program_texture_color::bind_attribute_locations()
{
	program_texture_base::bind_attribute_locations();
...
void
program_3d_texture_color::bind_attribute_locations()
{
	program_texture_base::bind_attribute_locations();
	program_->bind_attrib_location(2, "color");
}
...
void
program_texture_alpha::bind_attribute_locations()
{
	program_texture_base::bind_attribute_locations();
...
void
program_texture_uniform_alpha::initialize_uniform_locations()
{
	program_texture_base::initialize_uniform_locations();
...
void
program_texture_uniform_alpha::set_alpha(float alpha) const
{
...
void
program_texture_uniform_color::initialize_uniform_locations()
{
	program_texture_base::initialize_uniform_locations();
	color_location_ = program_->get_uniform_location("color");
}
...
void
program_texture_uniform_color::set_color(const g2d::rgba& color) const
{
	g2d::program::set_uniform(color_location_, color);
}
...
void
program_text_base::initialize_uniform_locations()
{
	program_texture_base::initialize_uniform_locations();
	color_location_ = program_->get_uniform_location("color");
}
...
void
program_text_base::set_color(const g2d::rgba& color) const
{
	g2d::program::set_uniform(color_location_, color);
}
...
void
program_text_alpha_base::bind_attribute_locations()
{
	program_texture_base::bind_attribute_locations();
	program_->bind_attrib_location(2, "alpha");
}
...
void
program_text_alpha_base::initialize_uniform_locations()
{
	program_texture_base::initialize_uniform_locations();
	color_location_ = program_->get_uniform_location("color");
}
...
void
program_text_alpha_base::set_color(const g2d::rgb& color) const
{
	g2d::program::set_uniform(color_location_, color);
}
...
void
program_text_gradient_base::bind_attribute_locations()
{
	program_texture_base::bind_attribute_locations();
...
void
program_text_gradient_base::initialize_uniform_locations()
{
	program_texture_base::initialize_uniform_locations();
...
void
program_text_gradient_base::set_top_color(const g2d::rgba& color) const
{
	g2d::program::set_uniform(top_color_location_, color);
}

void
program_text_gradient_base::set_bottom_color(const g2d::rgba& color) const
{
...
void
program_intro_text::bind_attribute_locations()
{
	program_texture_base::bind_attribute_locations();
	program_->bind_attrib_location(2, "mix_factor");
}
...
void
program_intro_text::initialize_uniform_locations()
{
	program_texture_base::initialize_uniform_locations();
...
void
program_intro_text::set_top_color_text(const g2d::rgba& color) const
{
	g2d::program::set_uniform(top_color_text_location_, color);
}

void
program_intro_text::set_bottom_color_text(const g2d::rgba& color) const
{
	g2d::program::set_uniform(bottom_color_text_location_, color);
}

void
program_intro_text::set_top_color_outline(const g2d::rgba& color) const
{
	g2d::program::set_uniform(top_color_outline_location_, color);
}

void
program_intro_text::set_bottom_color_outline(const g2d::rgba& color) const
{
...
void
program_timer_text::initialize_uniform_locations()
{
	program_texture_base::initialize_uniform_locations();
...
void
program_timer_text::set_text_color(const g2d::rgba& color) const
{
	g2d::program::set_uniform(text_color_location_, color);
}

void
program_timer_text::set_outline_color(const g2d::rgba& color) const
{
...
void
program_grid_background::initialize_uniform_locations()
{
	program_texture_base::initialize_uniform_locations();
...
void
program_grid_background::set_theme_color(const g2d::rgb& color) const
{
	g2d::program::set_uniform(theme_color_location_, color);
}

void
program_grid_background::set_highlight_position(const g2d::vec2& position) const
{
	g2d::program::set_uniform(highlight_position_location_, position);
}

void
program_grid_background::set_highlight_fade_factor(float value) const
{
