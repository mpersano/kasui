...
sprite::sprite(const g2d::texture *texture, int left, int top, int width, int height, int left_margin, int right_margin,
...
void sprite::draw(float x, float y, int layer) const
{
