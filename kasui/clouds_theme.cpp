...
void
cloud::draw(vertex_array_type& gv) const
{
...
static int
cloud_depth_compare(const void *foo, const void *bar)
{
...
draw()
{
	...
	const g2d::mat4 proj_modelview =
		...
		g2d::mat4::translation(.5*window_width, .5*window_height, 0);
