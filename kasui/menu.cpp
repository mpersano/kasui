...
toggle_menu_item::toggle_menu_item(int sound, int &value, const std::string &active_sprite_true,
...
action_menu_item &menu::append_action_item(int sound, const std::string &active_sprite,
...
toggle_menu_item &menu::append_toggle_item(int sound, int &value, const std::string &active_sprite_true,
                                           const std::string &inactive_sprite_true,
                                           const std::string &active_sprite_false,
                                           const std::string &inactive_sprite_false)
{
    append_item(new toggle_menu_item(sound, value, active_sprite_true, inactive_sprite_true, active_sprite_false,
                                     inactive_sprite_false));
...
void menu::on_back_key()
{
    ...
    auto it = std::find_if(std::begin(item_list_), std::end(item_list_), [](auto &p) { return p->is_back_item(); });
