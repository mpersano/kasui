...
void background_draw_gradient()
{
    ...
    render::draw_quad(gradient_texture, {{0, 0}, {0, window_height}, {window_width, window_height}, {window_width, 0}},
                      {{u0, v0}, {u0, v1}, {u1, v1}, {u1, v0}}, -100);
}
