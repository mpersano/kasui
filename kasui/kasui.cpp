...
void
kasui_impl::on_resume()
{ }

void
kasui_impl::resize(int width, int height)
{
	if (!initialized_) {
...
void
kasui_impl::initialize(int width, int height)
{
	// resize
...
void
kasui_impl::add_http_request(http_request *req)
{
	http_requests_.push_back(req);
}

void
kasui_impl::poll_http_requests()
{
...
void
kasui_impl::on_touch_down(int x, int y)
{
...
void
kasui_impl::on_touch_up()
{
	get_cur_state()->on_touch_up();
}

void
kasui_impl::on_touch_move(int x, int y)
{
	float sx = x*window_width/viewport_width;
	float sy = (viewport_height - 1 - y)*window_height/viewport_height;
...
void
kasui_impl::on_back_key_pressed()
{
	get_cur_state()->on_back_key();
}

void
kasui_impl::on_menu_key_pressed()
{
...
void
kasui::resize(int width, int height)
{
...
void
kasui::on_touch_down(int x, int y)
{
...
void
kasui::on_touch_move(int x, int y)
{
	impl_->on_touch_move(x, y);
}

void
kasui::on_back_key_pressed()
{
	impl_->on_back_key_pressed();
}

void
kasui::on_menu_key_pressed()
{
	impl_->on_menu_key_pressed();
}

void
kasui::add_http_request(http_request *req)
{
